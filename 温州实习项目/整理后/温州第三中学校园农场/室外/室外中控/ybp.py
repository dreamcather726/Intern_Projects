...
class GaugeWidget(QWidget):
    ...
    用于展示温度、湿度等百分比数据。
    """
    def __init__(self, parent=None, min_value=0.0, max_value=60.0, colors=None):
        """
        初始化仪表盘控件。
        ...
        # --- 仪表盘几何形状定义 ---
        self.start_angle = 223   # 起始角度 (3点钟方向为0度，顺时针增加)
        self.total_angle = 268   # 总共跨越的角度 (从225度到-45度)
        self.gauge_width = 38     # 进度条的宽度
